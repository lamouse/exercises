...
},beforePageText:"页码",afterPageText:"共 {pages}",displayMsg:"显示 {from} 到  {to} 共  {total} 条记录",nav:{first:{iconCls:"pagination-first",handler:function(){
